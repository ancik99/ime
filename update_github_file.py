...
def generate_footer(dest_file_path: str, expired: bool) -> str:
    if expired:
        return '#EXTM3U billed-msg="MASA BERLAKU HABIS| 📲 Wa 085184670599😎"'
    return f'#EXTM3U billed-msg="😎{dest_file_path}| 📲 Wa 085184670599😎"'
...
def build_expired_playlist_block() -> str:
    return (
        '#EXTINF:-1 group-logo="https://i.imgur.com/aVBedkE.jpeg",🔰 BOLODEWE TV\n\n'
        '#EXTINF:-1 tvg-id="Iheart80s" tvg-name="Iheart80s" tvg-logo="https://i.imgur.com/CctbVah.jpeg" group-title="🔰 BOLODEWE TV", MASA BERLAKU HABIS\n'
        ...
        'https://iheart-iheart80s-1-us.roku.wurl.tv/playlist.m3u8\n\n'
        '#EXTINF:-1 group-logo="https://i.imgur.com/bjfYe6g.jpeg", 📲 Wa 085184670599\n\n'
        '#EXTINF:-1 tvg-id="Iheart80s" tvg-name="Iheart80s" tvg-logo="https://i.imgur.com/bjfYe6g.jpeg" group-title="✅ORDER DISINI 📲 Wa 085184670599", SILAHKAN RE ORDER\n'
        'https://iheart-iheart80s-1-us.roku.wurl.tv/playlist.m3u8\n\n'
        '#EXTINF:-1 group-logo="https://i.imgur.com/bjfYe6g.jpeg", 📲 Wa 085184670599 order\n\n'
        '#EXTINF:-1 tvg-id="Iheart80s" tvg-name="Iheart80s" tvg-logo="https://i.imgur.com/bjfYe6g.jpeg" group-title="✅ORDER DISINI 📲 Wa 085184670599", SILAHKAN RE ORDER\n'
        'https://iheart-iheart80s-1-us.roku.wurl.tv/playlist.m3u8\n\n'
    )
...
def get_source_content() -> str | None:
    try:
        ...
        headers = {"User-Agent": "MagelifeSync/1.0 (+https://lynk.id/bolodewestore)"}
